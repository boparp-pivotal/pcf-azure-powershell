...
function New-Network-Assets {
    ...
    $frontendIP = New-AzureRmLoadBalancerFrontendIpConfig -Name pcf-fe-ip -PublicIpAddress $publicIP
...
function New-VM {
    ...
    $vnet = Get-AzureRmVirtualNetwork -Name $networkOpts.vnetName -ResourceGroupName $resourceGroup
    $subnet = Get-AzureRmVirtualNetworkSubnetConfig -Name $networkOpts.subnetName -VirtualNetwork $vnet
    ...
    # Configure SSH Keys
    $sshPublicKey = Get-Content $ssh_key_path    
...
$networkOptions.vnetName = 'pcf-net'
$networkOptions.subnetAddressPrefix = '10.0.0.0/20'
$networkOptions.vnetAddressPrefix = '10.0.0.0/16'
$networkOptions.opsMgrPrivateIP = '10.0.0.5'
